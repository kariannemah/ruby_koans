...
class AboutClasses < Neo::Koan
  ...
  def test_args_to_new_must_match_initialize
    ...
    # THINK ABOUT IT:
    # We defined the initalize method as requiring one argument.
    # Here we call that method (that is, we instantiate a new object)
    # without supplying an argument, thereby raising an ArgumentError.
  end
