...
class AboutSymbols < Neo::Koan
  ...
  # although they are immutable and only allocted to memory once,
  # dynamically created symbols take up a lot of memory until the program
  # ends. only use them when you need to access the symbol a lot but don't
  # need to modify it.
end
