...
class AboutOpenClasses < Neo::Koan
  ...
  # more on namespace conventions??

  # :: is a unary operator. Use it to access constants, instance methods, and
  # class methods defined within a class or module from anywhere outside the class
  # or module.
end
