...
class AboutRegularExpressions < Neo::Koan
  ...
  def test_asterisk_means_zero_or_more
    ...
    assert_equal "bc", "abbcccddddeeeee"[/bz*c/]

    # THINK ABOUT IT:
    #
    # When would * fail to match?
    # * always accepts an empty string. * would fail to match if
    # it were a part of a regexp that tried to match an exact string.
  end
  ...
  # We call these operators greedy because they gobble up all
  # consecutive characters that match the character while still
  # allowing the overall match to succeed.
  ...
  def test_shortcut_character_classes_are_negated_with_capitals
    ...
    # negate any alphanumberic character
  ...
  def test_scan_is_like_find_all
    # find any word character strings
