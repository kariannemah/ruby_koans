...
class AboutClassMethods < Neo::Koan
  ...
  # I prefer the first way. In only one line (152) can we say,
  # "Ceate a method called 'method' and make it a method of the
  # class Demo.""
  #
  # When using the class << self block and assigning a LOT of
  # methods to one class, I think it could be tricky
  # to immediately note whether a given method is a class method
  # or an instance method. Whereas with def self.method, you always
  # know it's a class method.
